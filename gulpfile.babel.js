...
export const dataJson = () => gulp.src(paths.dataJson.src)
	.pipe(gulp.dest(paths.dataJson.dist))
	.pipe(debug({
		"title": "data json"
	}));
...
export const development = gulp.series(cleanFiles, smartGrid,
	gulp.parallel(dataJson, views, styles, scripts, svgsprites, images, webpimages, fonts, favs),
	gulp.parallel(server));

export const prod = gulp.series(cleanFiles, smartGrid, dataJson, serverConfig, views, styles, scripts, svgsprites, images, webpimages, fonts, favs);
